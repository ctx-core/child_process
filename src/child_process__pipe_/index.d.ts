...
export declare function child_process__pipe_(pipe?:child_process__receive_T):child_process__pipe_T;
export {
	child_process__pipe_ as pipe_child_process_,
	child_process__pipe_ as _pipe__child_process,
}
export type child_process__pipe_T = (child_process:ChildProcess, pipe?:child_process__receive_T)=>Promise<number>;
